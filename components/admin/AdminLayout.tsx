...
export const AdminLayout: React.FC<AdminLayoutProps> = ({ onLogout }) => {
    ...
    return (
        <div className="min-h-screen flex bg-stone-100">
            ...
            {/* Main Content */}
            <main className="flex-1 ml-20 lg:ml-72 p-8 lg:p-12 overflow-y-auto bg-stone-50 relative overflow-hidden">
                {/* Background Decor */}
                <div className="absolute bottom-0 right-0 opacity-10 pointer-events-none z-0">
                    <img src="/images/decor/flower-corner-white.png" alt="" className="w-64 transform scale-x-[-1]" />
                </div>
